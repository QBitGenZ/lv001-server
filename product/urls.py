...
from .views import ProductTypeView, ProductView, ProductPkView,ProductByUser,SoldProductView,TotalRevenueByUserAPIView, SearchProductView, SearchProductByUserView
...
urlpatterns = [
    ...
    path('myproducts/search/', SearchProductByUserView.as_view(), name='search'),
